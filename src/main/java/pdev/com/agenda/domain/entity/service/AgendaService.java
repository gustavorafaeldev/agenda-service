...
import pdev.com.agenda.domain.entity.repository.AgendaRepository;
...
public class AgendaService {
    ...
    public Optional<Agenda> listarPorId(Long id) {
        return repository.findById(id);
    }

    public Agenda salvar(Agenda agenda) {

        Optional<Paciente> optionalPaciente = pacienteService.listarPorId(agenda.getPaciente().getId());

        if (optionalPaciente.isEmpty()) {
            throw new BusinessException("Paciente não encotnrado!");
        }
